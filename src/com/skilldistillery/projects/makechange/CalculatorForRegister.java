...
public class CalculatorForRegister {
	...
	public void calculateBillsAndCoins(int changeDue) {
	...
	public void printIfStatement(int twenties, int tens, int fives, int singles, int quarters, int dimes, int nickels, int pennies) {
		if (twenties != 0) System.out.println("Twenty Dollar Bills: " + twenties);
		if (tens != 0) System.out.println("Ten Dollar Bills: " + tens);
		if (fives != 0) System.out.println("Five Dollar Bills: " + fives);	
		if (singles != 0) System.out.println("Singles: " + singles);
